...
from xwr_raw_ros2.msg import RadarFrame
from xwr_raw_ros2.msg import RadarFrameStamped
from xwr_raw_ros2.msg import RadarFrameFull
...
if __name__ == '__main__':
    ...
    dca = DCA1000(dca_ip          = args.dca_ip,
    ...
    rospy.on_shutdown(lambda : dca.close())
