...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('input_cloud_topic', default_value='/ti_mmwave/radar_scan_pcl'),
        ...
        DeclareLaunchArgument('sensor_model/hit', default_value='0.6'),
        DeclareLaunchArgument('sensor_model/miss', default_value='0.01'),
        DeclareLaunchArgument('sensor_model/min', default_value='0.01'),
        DeclareLaunchArgument('sensor_model/max', default_value='1.0'),
